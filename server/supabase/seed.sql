...
-- 3. SEED HANGOUTS
-- ============================================================================
INSERT INTO public.hangouts (id, title, description, hangout_date, hangout_time, location_name, latitude, longitude, cover_photo_url, group_id, created_by) VALUES
(
